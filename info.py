...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://voromil970:q9aLNL7nsD8EDzwL@cluster0.rlvax.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'api.modijiurl.com')
...
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", 'api.modijiurl.com')
